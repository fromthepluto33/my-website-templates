...
function renderFooter() {
  ...
  slot.innerHTML = `
    <footer class="footer">
      ...
      <div class="footer__copyright">© 2026 ${cafe.name || 'Суши Бар'} · ${cafe.kanji || '虹'}の寿司 · ${contacts.legal || ''}</div>
    </footer>`;
}
      ...
      <div class="modal__window">
        ...
        <div class="checkout-success" id="checkoutSuccess" hidden>
          <svg class="checkout-success__icon" viewBox="0 0 100 100">
            <circle cx="50" cy="50" r="46" fill="none" stroke="#e63946" stroke-width="2" class="draw-circle" />
            <path d="M30 52 L44 66 L70 38" fill="none" stroke="#e63946" stroke-width="3" stroke-linecap="square" class="draw-check" />
          </svg>
